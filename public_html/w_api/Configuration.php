...
class Configuration
{
	const RESELLER_REQUEST_SECRET = '635886f47fc34b225c8226e82f5af224edfa8f90efbe6a051361b6e2e6309433';
	const ERROR_REPORTING_LEVEL = '0';
	const DEPLOYED_HOSTNAME = 'lordexlighting.com';
	const CLOUD_HOSTNAME = 'pages.weeblycloud.com';
	const DEPLOYED_HOSTNAME_HEADER = 'X-W-Cloud-Host';
	const BUILDDATE = '1763535332';
